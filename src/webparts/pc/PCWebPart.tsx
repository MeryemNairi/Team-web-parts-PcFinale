...
import * as strings from 'PCWebPartStrings';
import CommPage from './components/CommPage';
import './PCWebPart.module.scss';
...
export default class CareerPageWebPart extends BaseClientSideWebPart<{}> {
  ...
  private setupGoogleAnalytics(): void {
    ...
    if (!document.getElementById(scriptId)) {
      ...
      script.id = scriptId;
      script.src = `https://www.googletagmanager.com/gtag/js?id=G-BYBX0L75CF`;
      script.async = true;
